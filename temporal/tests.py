...
class TemporalActivitiesTestCase(TestCase):
    def setUp(self):
        ...
        self.report_params = ReportParams(
            user_id=1,
    ...
    def test_update_task_status_activity_success(self, mock_sync_to_async, mock_update_task):
    ...
    @patch('temporal.activities.update_task_execution_status')
    @patch('temporal.activities.sync_to_async')
    def test_update_task_status_activity_error(self, mock_sync_to_async, mock_update_task):
    ...
    @patch('temporal.activities.sync_to_async')
    def test_update_execution_status_activity_success(self, mock_sync_to_async, mock_update_execution):
        async_result = AsyncMock()
        mock_sync_to_async.return_value = async_result
    ...
    @patch('temporal.activities.update_execution_status')
    @patch('temporal.activities.sync_to_async')
    def test_update_execution_status_activity_error(self, mock_sync_to_async, mock_update_execution):
        async_mock = AsyncMock()
        async_mock.side_effect = ValueError("Erro de teste")
        mock_sync_to_async.return_value = async_mock
    ...
    @patch('temporal.activities.sync_to_async')
    def test_send_email_activity_success(self, mock_sync_to_async, mock_mailer_service_class):
    ...
    @patch('temporal.activities.MailerSendService')
    @patch('temporal.activities.sync_to_async')
    def test_send_email_activity_error(self, mock_sync_to_async, mock_mailer_service_class):
        mock_mailer = MagicMock()
        mock_mailer_service_class.return_value = mock_mailer
    ...
    @patch('temporal.activities.sync_to_async')
    def test_generate_report_activity_success(self, mock_sync_to_async, mock_format_html, mock_report_generator_class):
    ...
    @patch('temporal.activities.EmailReportGenerator')
    @patch('temporal.activities.sync_to_async')
    def test_generate_report_activity_error(self, mock_sync_to_async, mock_report_generator_class):
        mock_generator = MagicMock()
        mock_report_generator_class.return_value = mock_generator
